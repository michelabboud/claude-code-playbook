# 0005 — Bind local Overrides to a unique, digested rule section

- **Status:** accepted, 2026-09-21 (owner-approved repair to the local-layer trust boundary).
- **Supersedes:** the staleness-check portion of ADR 0004.
...
trailing blanks, so line-ending and editor-only whitespace changes do not
