...
|---|---|---|---|
| [The local layer](docs/plans/2026-09-21-local-layer-plan.md) | **running** — five tasks built, the mechanical review's findings fixed, held for the batch's deep review | 2026-09-21 | 2026-09-21 |
