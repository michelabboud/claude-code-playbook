...
| Current load | `cat /proc/loadavg` | first three fields are the 1/5/15-minute load averages; divide the one you use by `nproc` to get the load factor SUBAGENTS.md's formula wants |
